...
import { Volume2, CheckCircle2, BookOpen, XCircle, Play } from "lucide-react";
...
export default function ListenAcademicTalk({
    question,
    onAnswer,
    reviewMode = false,
    userAnswer = "{}",
        ...
        <QuestionContainer question={question} hideHeader={true}>
            <div className="flex flex-col min-h-[500px] max-w-3xl mx-auto">
                <div className="text-center mb-8 space-y-2">
                    <span className="bg-orange-500/10 text-orange-600 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide">
                    ...
                    <div className="flex-1 flex items-center justify-center">
                        <div className="text-center space-y-4">
                            <div className="w-20 h-20 rounded-full bg-orange-500/20 flex items-center justify-center mx-auto">
                                <BookOpen className="w-10 h-10 text-orange-500 animate-pulse" />
                            </div>
                            <p className="text-lg">Loading talk...</p>
                        </div>
                    </div>
                )}
                ...
                {flowState === 'playing' && (
                    <div className="flex-1 flex items-center justify-center">
                        <div className="text-center space-y-6">
                            <div className="w-32 h-32 rounded-full bg-orange-500/20 flex items-center justify-center mx-auto relative">
                    ...
                    <div className="space-y-6">
                        {reviewMode ? (
                            <button
                                ...
                                className="flex items-center gap-2 p-3 bg-orange-500/10 border border-orange-500/20 rounded-lg text-orange-700 hover:bg-orange-500/20 transition-colors w-full justify-center mb-6"
                            >
                                <Play className="w-5 h-5" />
                                <span className="text-sm font-medium">Replay Talk</span>
                            </button>
                        ) : (
