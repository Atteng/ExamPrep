...
export default function ListenConversation({ question, onAnswer }: ListenConversationProps) {
    ...
    // Parse multi-question format
    // Assuming question.text is the conversation transcript
    // and question.options/answerKey might be array for multiple questions
    const conversationTranscript = question.text || "";

    // Use multi-question array if available, otherwise fallback to single question
    ...
    const handleSubmit = () => {
        // For now, submit the first answer (will update when multi-question is implemented)
